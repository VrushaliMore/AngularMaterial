...
(function () {
        ...
        return {
            ...
            fire: function () {
                ...
                return function (l, q, t) {
                    ...
                    if (f) {
                        var A = f.listeners;
                        if (A.length) for (var A = A.slice(0), u, C = 0; C < A.length; C++) {
                            if (f.errorProof) try {
                                u = A[C].call(this, t, q, b, h)
    ...
    (function () {
        ...
        CKEDITOR.tools = {
            ...
            createClass: function (a) {
                ...
                c && (b.prototype = this.prototypedCopy(c.prototype), b.prototype.constructor = b, b.base = c, b.baseProto = c.prototype, b.prototype.base = function () {
            ...
            getCookie: function (a) {
                a = a.toLowerCase();
                for (var b = document.cookie.split(";"), c, l, d = 0; d < b.length; d++) if (c = b[d].split("\x3d"),
    ...
    CKEDITOR.tools.extend(CKEDITOR.dom.node.prototype, {
        ...
        getIndex: function (a) {
            function d(a, b) {
                ...
                return c && c.nodeType == CKEDITOR.NODE_TEXT ? c.nodeValue ? c : d(c, b) : null
            }
            var b = this.$,
                c = -1,
                e;
            if (!this.$.parentNode || a && b.nodeType == CKEDITOR.NODE_TEXT && !b.nodeValue && !d(b) && !d(b, !0)) return -1;
            do if (!a || b == this.$ || b.nodeType != CKEDITOR.NODE_TEXT || !e && b.nodeValue) c++, e = b.nodeType == CKEDITOR.NODE_TEXT;
        ...
        CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
            ...
            removeStyle: function (a) {
                ...
                if (b.removeProperty || "border" != a && "margin" != a && "padding" != a) b.removeProperty ? b.removeProperty(a) : b.removeAttribute(CKEDITOR.tools.cssStyleToDomStyle(a)), this.$.style.cssText || this.removeAttribute("style");
                    ...
                    for (var b = [], d = 0; d < c.length; d++) if (f) for (var A = 0; A < f.length; A++) b.push([a, c[d], f[A]].join("-"));
            ...
            getDocumentPosition: function (a) {
                ...
                } else for (m = this, y = null; m && "body" != m.getName() && "html" != m.getName();) {
            ...
            b) {
                ...
                for (var f = 0; f < c.length; f++) {
                    var d = c[f],
                        ...
                        u;
                    if (!(e in b)) if ("checked" == e && (u = this.getAttribute(e))) a.setAttribute(e, u);
    ...
    (function () {
        function a(a, b) {
            ...
            this.current ? f = this.current[n](!1, p, x) : (a ? f.type == CKEDITOR.NODE_ELEMENT && (f = 0 < z ? f.getChild(z - 1) : !1 === x(f, !0) ? null : f.getPreviousSourceNode(!0, p, x)) : (f = d, f.type == CKEDITOR.NODE_ELEMENT && ((f = f.getChild(e)) || (f = !1 === x(d, !0) ? null : d.getNextSourceNode(!0, p, x)))), f && !1 === x(f) && (f = null));
            for (; f && !this._.end;) {
                this.current = f;
        ...
        CKEDITOR.dom.walker.empty = function (a) {
            return function (b) {
                for (var c = 0, f = b.getChildCount(); c < f; ++c) if (!t(b.getChild(c))) return !!a;
                return !a
            }
        };
        ...
        CKEDITOR.dom.walker.editable = function (a) {
            return function (b) {
                b = t(b) ? !1 : b.type == CKEDITOR.NODE_TEXT || b.type == CKEDITOR.NODE_ELEMENT && (b.is(CKEDITOR.dtd.$inline) || b.is("hr") || "false" == b.getAttribute("contenteditable") || !CKEDITOR.env.needsBrFiller && b.is(z) && f(b)) ? !0 : !1;
                return !!(a ^ b)
            }
        };
    ...
    (function () {
        ...
        function d(a, b, c, d, e) {
            ...
            function g() {
                ...
                for (a = 0; a < f; a++) if (b = w[a], c = H[a], !b.equals(c)) return a;
                return a - 1
            }
            function h() {
                var b = I - 1,
            ...
            enlarge: function (a, b) {
                ...
                switch (a) {
                    ...
                    case CKEDITOR.ENLARGE_ELEMENT:
                        ...
                        r.type == CKEDITOR.NODE_TEXT ? (B && (r = !CKEDITOR.tools.trim(r.substring(0, B)).length && r, D = !! r), r && ((p = r.getPrevious()) || (k = r.getParent()))) : (B && (p = r.getChild(B - 1) || r.getLast()), p || (k = r));
                        for (k = c(k); k || p;) {
                            if (k && !p) {
                                !n && k.equals(g) && (n = !0);
                            ...
                            for (; p;) if (r = !1, p.type == CKEDITOR.NODE_COMMENT) p = p.getPrevious();
                            else {
                                if (p.type == CKEDITOR.NODE_TEXT) F = p.getText(), d.test(F) && (p = null), r = /[\s\ufeff]$/.test(F);
                                else if ((p.$.offsetWidth > (CKEDITOR.env.webkit ? 1 : 0) || b && p.is("br")) && !p.data("cke-bookmark")) if (D && CKEDITOR.dtd.$removeEmpty[p.getName()]) {
                                    F = p.getText();
                                    if (d.test(F)) p = null;
                                    else for (var B = p.$.getElementsByTagName("*"), t = 0, q; q = B[t++];) if (!CKEDITOR.dtd.$removeEmpty[q.nodeName.toLowerCase()]) {
                                        p = null;
                                        break
                                    }
                                    p && (r = !! F.length)
                        ...
                        k = p = null;
                        n = D = !1;
                        r.type == CKEDITOR.NODE_TEXT ? CKEDITOR.tools.trim(r.substring(B)).length ? D = !0 : (D = !r.getLength(), B == r.getLength() ? (p = r.getNext()) || (k = r.getParent()) : m(r, B) && (k = r.getParent())) : (p = r.getChild(B)) || (k = r);
                        for (; k || p;) {
                            if (k && !p) {
                                !n && k.equals(g) && (n = !0);
                                if (e ? k.isBlockBoundary() : !h.contains(k)) break;
                            ...
                            for (; p;) {
                                ...
                                if (p.type == CKEDITOR.NODE_TEXT) F = p.getText(), m(p, 0) || (p = null), r = /^[\s\ufeff]/.test(F);
                                    ...
                                    if ((0 < p.$.offsetWidth || b && p.is("br")) && !p.data("cke-bookmark")) if (D && CKEDITOR.dtd.$removeEmpty[p.getName()]) {
                                        F = p.getText();
                                        if (d.test(F)) p = null;
                                        else for (B = p.$.getElementsByTagName("*"), t = 0; q = B[t++];) if (!CKEDITOR.dtd.$removeEmpty[q.nodeName.toLowerCase()]) {
                                            p = null;
                                            break
                                        }
                                        p && (r = !! F.length)
    ...
    (function () {
        function a(a, b, c, d, e) {
            ...
            for (k in b) {
                ...
                for (m in S) {
                    ...
                    for (; J = D.pop();) g[J] = g["!" + J], delete g["!" + J];
                    G[f] = (F ? !1 : x) || null
                }
            ...
            for (d = a.length; c < d; ++c) {
                ...
                if (!0 === k.elements || null === k.elements) e[p ? "unshift" : "push"](k);
                else for (l in n = k.elements, delete k.elements, n) if (b[l]) b[l][p ? "unshift" : "push"](k);
                else b[l] = [k]
            }
        }
        function d(a, c, d, k) {
            if (!a.match || a.match(c)) if (k || l(a, c)) if (a.propertiesOnly || (d.valid = !0), d.allAttributes || (d.allAttributes = b(a.attributes, c.attributes, d.validAttributes)), d.allStyles || (d.allStyles = b(a.styles, c.styles, d.validStyles)), !d.allClasses) {
                a = a.classes;
                c = c.classes;
                k = d.validClasses;
                if (a) if (!0 === a) a = !0;
                else {
                    for (var e = 0, p = c.length, n; e < p; ++e) n = c[e], k[n] || (k[n] = a(n));
                    a = !1
                } else a = !1;
                d.allClasses = a
            }
        ...
        function c(a, b, c) {
            if (!a.match || a.match(b)) {
                ...
                b = b.classes;
                if (a) {
                    for (var d = !1, k = !0 === a, p = b.length; p--;) if (k || a(b[p])) b.splice(p, 1), d = !0;
                    a = d
                } else a = !1;
        ...
        b) {
            ...
            var c = !1,
                d = !0 === a,
                k;
            for (k in b) if (d || a(k)) delete b[k], c = !0;
            return c
        }
        function g(a, b, c) {
        ...
        function l(a, b) {
            ...
            var c, d, k, p;
            if (k = a.requiredClasses) for (p = b.classes, c = 0; c < k.length; ++c) if (d = k[c], "string" == typeof d) {
        ...
        function u(a, b, k, e) {
            ...
            if (e.doCallbacks && a.elementCallbacks) {
                a: {
                    ...
                    for (var f = 0, x = r.length, g; f < x; ++f) if (g = r[f](b)) {
                        r = g;
                        break a
                    }
                    r = void 0
            ...
            if (e.doFilter) {
                a: {
                    f = b.name;
                    x = a._;
                    a = x.allowedRules.elements[f];
                    r = x.allowedRules.generic;
                    f = x.disallowedRules.elements[f];
                    x = x.disallowedRules.generic;
                    g = e.skipRequired;
                    var D = {
                        valid: !1,
                        validAttributes: {},
                    ...
                    if (a || r) {
                        A(b);
                        if (f) for (w = 0, h = f.length; w < h; ++w) if (!1 === c(f[w], b, D)) {
                            a = null;
                            break a
                        }
                        if (x) for (w = 0, h = x.length; w < h; ++w) c(x[w], b, D);
                        if (a) for (w = 0, h = a.length; w < h; ++w) d(a[w], b, D, g);
                        if (r) for (w = 0, h = r.length; w < h; ++w) d(r[w], b, D, g);
                        a = D
                    } else a = null
                }
                ...
                if (!a.allAttributes) for (B in f) h[B] || (L.test(B) ? B == (H = B.replace(/^data-cke-saved-/, "")) || h[H] || (delete f[B], w = !0) : (delete f[B], w = !0));
        ...
        function k(a, b, c) {
            ...
            else if (B.$block[d] || "tr" == d) if ("br" == b) a.previous && !x(a.previous) && (b = v(), b.insertBefore(a)), a.next && !x(a.next) && (b = v(), b.insertAfter(a)), a.replaceWithChildren();
            else {
                var d = a.children,
                    k;
                b: {
                    k = B[b];
                    for (var e = 0, p = d.length, n; e < p; ++e) if (n = d[e], n.type == CKEDITOR.NODE_ELEMENT && !k[n.name]) {
                        k = !1;
                        break b
                    }
                    k = !0
        ...
        function p(a, b, c) {
            var d, k;
            for (d = 0; d < c.length; ++d) if (k = c[d], !(k.check && !a.check(k.check, !1) || k.left && !k.left(b))) {
                k.right(b, O);
                break
            }
        }
        function n(a, b) {
            ...
            for (e in d) if ("class" == e) for (c = d[e].split(/\s+/), n = a.classes.join("|"); r = c.pop();) {
                if (-1 == n.indexOf(r)) return !1
            } else if (a.attributes[e] != d[e]) return !1;
            for (p in k) if (a.styles[p] != k[p]) return !1;
            return !0
        }
        function D(a, b) {
            var c, d;
        ...
        CKEDITOR.filter.prototype = {
            allow: function (b, c, d) {
                ...
                if ("string" == typeof b) b = f(b);
                    ...
                    d && (d = L(d), k.classes = d["class"] ? d["class"].split(/\s+/) : null, k.requiredClasses = k.classes, delete d["class"], k.attributes = d, k.requiredAttributes = d && CKEDITOR.tools.objectKeys(d))
            ...
            applyTo: function (a, b, c, d) {
                ...
                a.forEach(function (a) {
                    if (a.type == CKEDITOR.NODE_ELEMENT) {
                        ...
                        if (!b || "span" != a.name || !~CKEDITOR.tools.objectKeys(a.attributes).join("|").indexOf("data-cke-")) if (r = u(e, a, p, m), r & 1) f = !0;
                        ...
                        a: {
                            ...
                            c = [];
                            var k, x, g;
                            if (n) for (x = 0; x < n.length; ++x) if ((g = d.match(n[x])) && g[0].length == d.length) {
                                c = !0;
                                break a
                            }
                            d = CKEDITOR.htmlParser.fragment.fromHtml(d);
                            1 == d.children.length && (k = d.children[0]).type == CKEDITOR.NODE_ELEMENT && u(e, k, c, m);
                            c = !c.length
                        }
                        c || p.push(a)
                    }
                ...
                for (; x = a.pop();) if (c = x.el, c.parent) switch (g = B[c.parent.name] || B.span, x.check) {
                    case "it":
                        B.$removeEmpty[c.name] && !c.children.length ? k(c, d, a) : y(c) || k(c, d, a);
                        break;
                    case "el-up":
                        c.parent.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || g[c.name] || k(c, d, a);
                        break;
                    case "parent-down":
                ...
                if (!this.disabled && a) {
                    ...
                    for (k = 0; k < a.length; ++k) {
                        ...
                        var e = void 0,
                            ...
                            m = void 0;
                        c = [];
                        for (p = 0; p < b.length; ++p) n = b[p], "string" == typeof n ? (n = n.split(/\s*:\s*/), f = n[0], x = null, m = n[1]) : (f = n.check, x = n.left, m = n.right), e || (e = n, e = e.element ? e.element : f ? f.match(/^([a-z0-9]+)/i)[0] : e.left.getDefinition().element), x instanceof CKEDITOR.style && (x = r(x)), c.push({
                            check: f == e ? null : f,
                            left: x,
            ...
            check: function (a, b, c) {
                ...
                if (!1 !== b && (x = this._.transformations[k.name])) {
                    for (d = 0; d < x.length; ++d) p(this, k, x[d]);
                    m(k)
                }
                u(this, n, r, {
                    doFilter: !0,
                ...
                transform: function (a, b) {
                    if ("string" == typeof b) a.name = b;
                        ...
                        var c = b.getDefinition(),
                            ...
                            e, p, n, r;
                        a.name = c.element;
                        for (e in k) if ("class" == e) for (c = a.classes.join("|"), n = k[e].split(/\s+/); r = n.pop();) - 1 == c.indexOf(r) && a.classes.push(r);
    ...
    CKEDITOR.resourceManager.prototype = {
        ...
        load: function (a, d, b) {
            ...
            for (var c = this.loaded, e = this.registered, g = [], h = {}, l = {}, q = 0; q < a.length; q++) {
                var t = a[q];
                if (t) if (c[t] || e[t]) l[t] = this.get(t);
                else {
            ...
            CKEDITOR.scriptLoader.load(g, function (a, e) {
                ...
                for (var f = 0; f < a.length; f++) for (var g = h[a[f]], m = 0; m < g.length; m++) {
                    var y = g[m];
                    l[y] = this.get(y);
                    c[y] = 1
                }
                ...
                a.call(this, b, function (a) {
                    ...
                    for (f in a) {
                        var l = a[f],
                            A = l && l.requires;
                        if (!d[f]) {
                            if (l.icons) for (var u = l.icons.split(","), C = u.length; C--;) CKEDITOR.skin.addIcon(u[C], l.path + "icons/" + (CKEDITOR.env.hidpi && l.hidpi ? "hidpi/" : "") + u[C] + ".png");
                            d[f] = 1
                        }
        ...
        function z(a) {
            ...
            CKEDITOR.plugins.load(c.split(","), function (c) {
                ...
                for (var f in c) {
                    ...
                    if (l && (w = l.match(p))) for (; l = w.pop();) CKEDITOR.error("editor-plugin-required", {
                        plugin: l.replace(",", ""),
                        requiredBy: f
                    });
        ...
        CKEDITOR.htmlParser.prototype = {
            ...
            parse: function (b) {
                for (var c, e, g = 0, h; c = this._.htmlPartsRegex.exec(b);) {
                    e = c.index;
                    if (e > g) if (g = b.substring(g, e), h) h.push(g);
                    else this.onText(g);
    ...
    (function () {
        ...
        CKEDITOR.htmlParser.fragment.fromHtml = function (g, h, l) {
            function q(a) {
                var b;
            ...
            C.onTagOpen = function (e, n, f, r) {
                ...
                if (a(n)) y.push(n);
                    ...
                    if ("br" == e) E.push(n);
                        ...
                        for (; !(r = (f = v.name) ? CKEDITOR.dtd[f] || (v._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c, n.isUnknown || v.isUnknown || r[e]);) if (v.isOptionalClose) C.onTagClose(f);
                        ...
                        else if (e in CKEDITOR.dtd.$listItem && !u(e, f)) C.onTagOpen("li" == e ? "ul" : "dl", {}, 0, 1);
        ...
        a.prototype = {
            ...
            exec: function (a, c) {
                var d = c instanceof CKEDITOR.htmlParser.node || c instanceof CKEDITOR.htmlParser.fragment,
                    ...
                    l = h.length,
                    q, t, f, z;
                for (z = 0; z < l; z++) if (d && (q = c.type, t = c.name), f = h[z], !(a.nonEditable && !f.options.applyToAll || a.nestedEditable && f.options.excludeNestedEditable)) {
    ...
    (function () {
                ...
                return function (k) {
                    if (k.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
                        var e = [],
                            p = b(k),
                            r, w;
                        if (p) for (f(p, 1) && e.push(p); p;) g(p) && (r = c(p)) && f(r) && ((w = c(r)) && !g(w) ? e.push(r) : (n(x).insertAfter(r), r.remove())), p = p.previous;
                        for (p = 0; p < e.length; p++) e[p].remove();
                        if (e = !a || !1 !== ("function" == typeof d ? d(k) : d)) x || CKEDITOR.env.needsBrFiller || k.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT ? x || CKEDITOR.env.needsBrFiller || !(7 < document.documentMode || k.name in CKEDITOR.dtd.tr || k.name in CKEDITOR.dtd.$listItem) ? (e = b(k), e = !e || "form" == k.name && "input" == e.name) : e = !1 : e = !1;
                        e && k.add(n(a))
                    }
                }
            }
        ...
        CKEDITOR.htmlDataProcessor = function (b) {
            ...
            b.on("toHtml", function (a) {
                ...
                c = z(c);
                c = u(c);
                k = !1 === a.fixForBody ? !1 : d(a.enterMode, b.config.autoParagraph);
    ...
    (function () {
        ...
        CKEDITOR.htmlParser.element.prototype = CKEDITOR.tools.extend(new CKEDITOR.htmlParser.node, {
            ...
            filter: function (a, b) {
                ...
                var q, t;
                for (q in h) {
                    for (l = h[q];;) if (t = a.onAttributeName(b, q)) if (t != q) delete h[q], q = t;
                    else break;
                    else {
                        delete h[q];
                        break
                    }
                    t && (!1 === (l = a.onAttribute(b, d, t, l)) ? delete h[t] : h[t] = l)
                }
    ...
    (function () {
        ...
        function b(a) {
            ...
            h == CKEDITOR.ELEMENT_MODE_REPLACE ? (d.hide(), b.insertAfter(d)) : d.append(b);
            a.container = b;
        ...
        CKEDITOR.editor.prototype.resize = function (a, b, d, h) {
            ...
            h.setSize("width", a, !0);
            t && (t.style.width = "1%");
            var f = (h.$.offsetHeight || 0) - (q.$.clientHeight || 0),
    ...
    (function () {
        function a(a) {
            ...
            }, !n.checkForward() || e.checkStartOfBlock() && e.checkEndOfBlock()) && (b = r.fixBlock(!0, b.activeEnterMode == CKEDITOR.ENTER_DIV ? "div" : "p"), CKEDITOR.env.needsBrFiller || (b = b.getFirst(c)) && b.type == CKEDITOR.NODE_TEXT && CKEDITOR.tools.trim(b.getText()).match(/^(?:&nbsp;|\xa0)$/) && b.remove(), F = 1, a.cancel());
            F && r.select()
        }
        function d(a, b) {
        ...
        CKEDITOR.editable = CKEDITOR.tools.createClass({
            ...
            proto: {
                ...
                insertElementIntoRange: function (a, b) {
                    ...
                    var h, g;
                    if (f) for (;
                    (h = b.getCommonAncestor(0, 1)) && (g = CKEDITOR.dtd[h.getName()]) && (!g || !g[e]);) h.getName() in CKEDITOR.dtd.span ? b.splitElement(h) : b.checkStartOfBlock() && b.checkEndOfBlock() ? (b.setStartBefore(h), b.collapse(!0), h.remove()) : b.splitBlock(d == CKEDITOR.ENTER_DIV ? "div" : "p", c.editable());
                    b.insertNode(a);
                    return !0
                },
                    ...
                    if (!this.is("textarea")) {
                        ...
                        CKEDITOR.env.webkit && this.attachListener(a,
                            ...
                            if (b in h) {
                                ...
                                f = b.block,
                                d = c.endPath().block,
                                f && d && !f.equals(d) ? (a.fire("saveSnapshot"), (k = f.getBogus()) && k.remove(), c.enlarge(CKEDITOR.ENLARGE_INLINE), c.deleteContents(), d.getParent() && (d.moveChildren(f, !1), b.lastElement.mergeSiblings(), t(f, d, !0)), c = a.getSelection().getRanges()[0],
        ...
        var f = CKEDITOR.dom.walker.whitespaces(!0),
            ...
            m = function () {
                ...
                function b(c, d) {
                    ...
                    e = d.range.startPath();
                    for (var r = B[r.getName()], g = 0, D = c.getChildren(), l = D.count(), F = -1, m = -1, t = 0, q = e.contains(B.$list); g < l; ++g) e = D.getItem(g), a(e) ? (n = e.getName(), q && n in CKEDITOR.dtd.$list ? h = h.concat(b(e, d)) : (p = !! r[n], "br" != n || !e.data("cke-eol") || g && g != l - 1 || (t = (f = g ? h[g - 1].node : D.getItem(g + 1)) && (!a(f) || !f.is("br")), f = f && a(f) && B.$block[f.getName()]), -1 != F || p || (F = g), p || (m = g), h.push({
                        isElement: 1,
                        isLineBreak: t,
                ...
                function r(b, c, d, e) {
                    ...
                    (f = (new CKEDITOR.dom.walker(k)).next()) && a(f) && m[f.getName()] && (n = f.getPrevious()) && a(n) && !n.getParent().equals(b.startContainer) && d.contains(n) && e.contains(f) && f.isIdentical(n) && (f.moveChildren(n), f.remove(), r(b, c, d, e))
                }
                function g(b, c) {
                    function d(b, c) {
                    ...
                    if (!I.checkReadOnly()) {
                        ...
                        if (K = H) {
                            ...
                            if ("text" == m.type && m.inlineStylesRoot) {
                                ...
                                for (I = m.inlineStylesRoot.getParent(); !u.equals(I);) w = w.appendTo(u.clone()), u = u.getParent();
                            ...
                            if ((A = K.startPath().block) && (1 != A.getChildCount() || !A.getBogus())) a: {
                                ...
                                if (1 == u.getChildCount() && a(z = u.getFirst()) && z.is(t) && !z.hasAttribute("contenteditable")) {
                                    ...
                                    K = 0;
                                    for (I = A.count(); K < I; K++) if (w = A.getItem(K), !w.is(q)) break a;
                        ...
                        if (K) {
                            ...
                            1 != w.length ? C = !1 : (C = w[0], C = C.isElement && "false" == C.node.getAttribute("contenteditable"));
                    ...
                    table: function () {
                        ...
                        return {
                            ...
                            detectRanges: function (e, f) {
                                ...
                                w = w.contains("table");
                                l = l.contains("table");
                                if (w || l) w && l && b(w, l) ? (e.tableSurroundingRange = h, h.setStartAt(w, CKEDITOR.POSITION_AFTER_END), h.setEndAt(l, CKEDITOR.POSITION_BEFORE_START), h = k.clone(), h.setEndAt(w, CKEDITOR.POSITION_AFTER_END), g = k.clone(), g.setStartAt(l, CKEDITOR.POSITION_BEFORE_START), g = a(h).concat(a(g))) : w ? l || (e.tableSurroundingRange = h, h.setStartAt(w, CKEDITOR.POSITION_AFTER_END), k.setEndAt(w, CKEDITOR.POSITION_AFTER_END)) : (e.tableSurroundingRange = h, h.setEndAt(l, CKEDITOR.POSITION_BEFORE_START), k.setStartAt(l, CKEDITOR.POSITION_AFTER_START)), e.tableContentsRanges = g ? g : a(k)
                            },
    ...
    (function () {
        ...
        CKEDITOR.on("instanceCreated", function (b) {
            ...
            e.on("contentDom", function () {
                ...
                g.attachListener(g, CKEDITOR.env.webkit ? "DOMFocusIn" : "focus", function () {
                    w && CKEDITOR.env.webkit && (w = e._.previousActive && e._.previousActive.equals(f.getActive()));
                    e.unlockSelection(w);
                    w = 0
                }, null, null, -1);
        ...
        CKEDITOR.dom.selection.prototype = {
            getNative: function () {
                return void 0 !== this._.cache.nativeSel ? this._.cache.nativeSel : this._.cache.nativeSel = E ? this.document.$.selection : this.document.getWindow().$.getSelection()
            },
            getType: E ? function () {
                var a = this._.cache;
            ...
            getRanges: function () {
                var a = E ? function () {
                        ...
                        var b = function (b, c) {
                            ...
                            w = e.length - 1, l = -1, n, m; g <= w;) if (l = Math.floor((g + w) / 2), f = e[l], h.moveToElementText(f), n = h.compareEndPoints("StartToStart", b), 0 < n) w = l - 1;
                            else if (0 > n) g = l + 1;
                            else return {
                                container: d,
                                offset: a(f)
                            ...
                            if (-1 == l || l == e.length - 1 && 0 > n) {
                                ...
                                for (d = e.length; 0 < h && 0 < d;) k = e[--d], k.nodeType == CKEDITOR.NODE_TEXT && (m = k, h -= k.nodeValue.length);
                                return {
                                    container: m,
                                    offset: -h
                                }
                        ...
                        return function () {
                            ...
                            if (d == CKEDITOR.SELECTION_ELEMENT) {
                                for (var d = [], e = 0; e < c.length; e++) {
                                    for (var f = c.item(e), k = f.parentNode, h = 0, a = new CKEDITOR.dom.range(this.root); h < k.childNodes.length && k.childNodes[h] != f; h++);
                ...
                if (a.length) if (this.isLocked) {
                    ...
                    if (g) this.fake(g);
                        ...
                        if (E) {
                            ...
                            if (g.startContainer.type == CKEDITOR.NODE_ELEMENT && g.startContainer.getName() in b || g.endContainer.type == CKEDITOR.NODE_ELEMENT && g.endContainer.getName() in b) g.shrink(CKEDITOR.NODE_ELEMENT, !0), a = g.collapsed;
                            u = g.createBookmark();
                            b = u.startNode;
                            a || (f = u.endNode);
    ...
    (function () {
            ...
            if (c.collapsed) f = E(this, f), c.insertNode(f), c.moveToPosition(f, CKEDITOR.POSITION_BEFORE_END);
                ...
                for (r.getPosition(q) == CKEDITOR.POSITION_FOLLOWING && (r = 0); r;) {
                    ...
                    if (r.equals(q)) r = null, l = !0;
                        ...
                        if (x && m && CKEDITOR.dtd.$block[v]) for (var A = r, y = e(A), B = void 0, D = y.length, F = 0, A = D && new CKEDITOR.dom.range(A.getDocument()); F < D; ++F) {
                            var B = y[F],
                        ...
                        if (y) if (B = r.getParent(), y = g, D = h, F = k, !B || !(B.getDtd() || CKEDITOR.dtd.span)[D] && !F || y.parentRule && !y.parentRule(B)) l = !0;
                        else {
                            if (u || v && CKEDITOR.dtd.$removeEmpty[v] && (r.getPosition(q) | M) != M || (u = c.clone(), u.setStartBefore(r)), v = r.type, v == CKEDITOR.NODE_TEXT || x || v == CKEDITOR.NODE_ELEMENT && !r.getChildCount()) {
                                for (var v = r, Z;
                    ...
                    if (l && u && !u.collapsed) {
                        for (var l = E(this, f), x = l.hasAttributes(), z = u.getCommonAncestor(), v = {}, y = {}, B = {}, D = {}, V, Q, da; l && z;) {
                            if (z.getName() == h) {
                                for (V in g.attributes)!D[V] && (da = z.getAttribute(Q)) && (l.getAttribute(V) == da ? y[V] = 1 : D[V] = 1);
        ...
        function c(a) {
            ...
            var c = a.createBookmark(),
                d = c.startNode;
            if (a.collapsed) {
                for (var e = new CKEDITOR.dom.elementPath(d.getParent(), a.root), f, h = 0, g; h < e.elements.length && (g = e.elements[h]) && g != e.block && g != e.blockLimit; h++) if (this.checkElementRemovable(g)) {
                    var l;
        ...
        function q(a) {
            ...
            for (var d, e; d = c.getNextParagraph();) this.checkElementRemovable(d) && (d.is("pre") ? ((e = this._.enterMode == CKEDITOR.ENTER_BR ? null : a.document.createElement(this._.enterMode == CKEDITOR.ENTER_P ? "p" : "div")) && d.copyAttributes(e), t(d, e)) : u.call(this, d));
            a.moveToBookmark(b)
        }
        function t(a, b) {
            var c = !b;
        ...
        function u(a, b) {
            ...
            m(a, e, D[a.getName()]);
            f && (this._.definition.alwaysRemoveElement ? y(a, 1) : !CKEDITOR.dtd.$block[a.getName()] || this._.enterMode == CKEDITOR.ENTER_BR && !a.hasAttributes() ? y(a) : a.renameNode(this._.enterMode == CKEDITOR.ENTER_P ? "p" : "div"))
        }
        function C(a) {
                ...
                uiElement: function (a, b, c, d, e, f, g) {
                    if (!(4 > arguments.length)) {
                        var h = (d.call ? d(b) : d) ||
                            "div",
                            p = ["\x3c", h, " "],
                            m = (e && e.call ? e(b) : e) || {}, k = (f && f.call ? f(b) : f) || {}, q = (g && g.call ? g.call(this, a, b) : g) || "",
    ...
    CKEDITOR.plugins.add("scayt", {
        ...
        menuGenerator: function (a, c) {
            var d = a.scayt,
                ...
                e = {}, f = a.config.scayt_contextCommands.split("|"),
